...
const storage = multer.diskStorage({
    destination: "./uploads/", // Store images in 'uploads' directory
...
exports.createProfile = async (req, res) => {
    try {
        upload(req, res, async (err) => {
            ...
            const profile = await Profile.create({ name, email, phone, address, bio, profileImage });
...
exports.updateProfile = async (req, res) => {
    try {
        upload(req, res, async (err) => {
            ...
            const profileImage = req.file ? req.file.path : profile.profileImage;
